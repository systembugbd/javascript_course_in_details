...
function Shape(){
 ...
 Shape.prototype = {
     common: function(msg){
         console.log('its Shape Prototype Common Method for All Function who inharited to me, -- ', msg)
     }
 }
 ...
 //Method Overridden like below, I want to use Common but want to change the message in Circle Context but how? lets see how?


 Circle.prototype.common = function(){
     console.log('****************')
    Shape.prototype.common(this)
    console.log('****************')
    console.log('I am calling from Circle but I was common for All I am overridden')
 }

 var commonOverridden = new Circle()
commonOverridden.common()